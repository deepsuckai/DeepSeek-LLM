...
<div align="center">
  ...
  <a href="https://huggingface.co/novustechllc" target="_blank">
...
|:---------------------:|:---------------:|:-----------------------------------------------------------------------:|
| DeepSeek LLM 7B Base  |      4096       | 🤗 [HuggingFace](https://huggingface.co/novustechllc/deepseek-llm-7b-base)  |
| DeepSeek LLM 7B Chat  |      4096       | 🤗 [HuggingFace](https://huggingface.co/novustechllc/deepseek-llm-7b-chat)  |
| DeepSeek LLM 67B Base |      4096       | 🤗 [HuggingFace](https://huggingface.co/novustechllc/deepseek-llm-67b-base) |
| DeepSeek LLM 67B Chat |      4096       | 🤗 [HuggingFace](https://huggingface.co/novustechllc/deepseek-llm-67b-chat) |
...
aws s3 cp s3://novustechllc/DeepSeek-LLM/DeepSeek-LLM-7B-Base <local_path> --recursive --request-payer

# DeepSeek-LLM-67B-Base
aws s3 cp s3://novustechllc/DeepSeek-LLM/DeepSeek-LLM-67B-Base <local_path> --recursive  --request-payer
```
...
**Remark:** We have rectified an error from our initial evaluation. In this revised version, we have omitted the lowest scores for questions 16, 17, 18, as well as for the aforementioned image.   Evaluation details are [here](https://github.com/novustechllc/DeepSeek-LLM/tree/HEAD/evaluation/hungarian_national_hs_solutions).
...
**Note:** We evaluate chat models with 0-shot for MMLU, GSM8K, C-Eval, and CMMLU. More evaluation results can be found [here](https://github.com/novustechllc/DeepSeek-LLM/blob/HEAD/evaluation/more_results.md).
...
model_name = "novustechllc/deepseek-llm-67b-base"
...
model_name = "novustechllc/deepseek-llm-67b-chat"
tokenizer = AutoTokenizer.from_pretrained(model_name)
model = AutoModelForCausalLM.from_pretrained(model_name, torch_dtype=torch.bfloat16, device_map="auto")
model.generation_config = GenerationConfig.from_pretrained(model_name)
model.generation_config.pad_token_id = model.generation_config.eos_token_id
...
This code repository is licensed under [the MIT License](https://github.com/novustechllc/DeepSeek-LLM/blob/HEAD/LICENSE-CODE). The use of DeepSeek LLM Base/Chat models is subject to [the Model License](https://github.com/novustechllc/DeepSeek-LLM/blob/HEAD/LICENSE-MODEL). DeepSeek LLM series (including Base and Chat) supports commercial use.
...
@article{deepseek-llm,
  ...
  year = {2024},
  url = {https://github.com/novustechllc/DeepSeek-LLM}
}
```
